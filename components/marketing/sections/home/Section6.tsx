...
export default function Section6({ classList }: any) {
  return (
    <>
                  ...
                  <div className="col-md-8">
                    ...
                    <div className="pera">
                      <p>
                        ...
                        satisfied clients have to say. From Fortune 500
                        companies to small”
                      </p>
                    </div>
              ...
              <SwiperSlide className="single-slider">
                <div className="row">
                  <div className="col-md-8">
                    ...
                    <div className="pera">
                      <p>
                        “Our dedication to excellence, and commitment to
                        building long-lasting partnerships have”
                      </p>
                    </div>
                    <div className="bottom-heading">
                      <h4>
